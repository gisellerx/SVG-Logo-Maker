...
describe ("Square", () => {
    test ("Creates blue square", () => {
        ...
        const blueSquare = `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="300" height="200"><square x="60" y="10" width="150" height="150" fill="blue"/><text x="135" y="100" font-size="60" text-anchor="middle" fill=""></text></svg>`
